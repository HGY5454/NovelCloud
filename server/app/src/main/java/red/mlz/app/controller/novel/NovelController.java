...
public class NovelController {
    ...
    public NovelListVo novelList(@RequestParam(name = "wp", required = false) String wp,
    ...
    public NovelVo novelInfo(@RequestParam(name="novelId") BigInteger novelId) {
...
//        String novelVoStr = JSON.toJSONString(novelVo);
//        return new Response<>(1001,novelVoStr);
        return novelVo;
    }

    @RequestMapping("/novel/kinds")
    public List<KindsListVo> Kinds(){
...
//                    kindsVo.setKindsImage(kind.getKindsImage());
    ...
    public ChildrenKindsVo ChildrenKinds(@RequestParam(name = "kindsId")BigInteger kindsId){
