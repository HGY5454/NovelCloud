...
public class KindsController {
    ...
    public Kinds getKinds(@RequestParam(name = "kindsId") BigInteger kindsId) {
        return kindsService.getKindsById(kindsId);
    }

    @RequestMapping("/kinds/createKinds")
    public String createKinds(@RequestParam(name = "kindsName") String kindsName,
    ...
    public String updateKinds(@RequestParam(name = "kindsId") BigInteger kindsId,
