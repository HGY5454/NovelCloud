...
public class NovelController {
    ...
    public NovelListVo novelList(@VerifiedUser User loginUser,
    ...
    public String createNovel(@RequestParam(name = "title") String title,
...
//        }
        ...
        return "novelId=" + result;
    }

    @RequestMapping("/novel/update")
    public String updateNovel(@RequestParam(name = "novelId") BigInteger novelId,
