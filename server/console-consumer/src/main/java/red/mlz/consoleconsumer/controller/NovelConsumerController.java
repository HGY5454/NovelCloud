...
import red.mlz.consoleconsumer.client.NovelServiceFeign;
...
public class NovelConsumerController {
    ...
    @Autowired
    private NovelServiceFeign novelServiceClient;
    ...
    public Response novelList(
        ...
        if (novelServiceClient.novelList(page, titleKeyWord) != null) {
            return new Response<>(1003);
        }
        return new Response<>(1001,novelServiceClient.novelList(page, titleKeyWord));
    }
    ...
    public String createNovel(
        ...
        if (novelServiceClient.createNovel(title, images, author, score, wordCount, synopsis, kindsId, tags, infoType, infoContent) == null) {
            return null;
        }
    ...
    public String updateNovel(
            ...
            @RequestParam(name = "infoType") String infoType,
            @RequestParam(name = "infoContent") String infoContent) {
        if (novelServiceClient.updateNovel(novelId, title, images, author, score, wordCount, synopsis, kindsId, tags, infoType, infoContent) == null) {
            return null;
        }
    ...
    public String deleteNovel(@RequestParam(name = "novelId") BigInteger novelId) {
        if (novelServiceClient.deleteNovel(novelId) == null) {}
